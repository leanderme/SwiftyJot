...
/// Public class for you to use to create a jot view! Import <jot.h> into your view controller, then create an instance of JotViewController and add it as a child of your view controller. Set the state of the JotViewController to switch between manipulating text and drawing.
///
...
SWIFT_CLASS("_TtC9SwiftyJot17JotViewController")
...
- (UIImage * _Nonnull)drawOnImage:(UIImage * _Nonnull)image;
...
- (UIImage * _Nonnull)renderImageOnColor:(UIColor * _Nonnull)color;

/// Renders the drawing and text at the view's size multiplied by the given scale with a transparent background.
///
/// @return An image of the rendered drawing and text.
- (UIImage * _Nonnull)renderImageWithScale:(CGFloat)scale;

/// Renders the drawing and text at the view's size multiplied by the given scale with a colored background.
///
/// @return An image of the rendered drawing and text on a colored background.
- (UIImage * _Nonnull)renderImageWithScale:(CGFloat)scale onColor:(UIColor * _Nonnull)color;
- (nonnull instancetype)init;
- (void)viewDidLoad;
- (UIImage * _Nonnull)renderImageWithSize:(CGSize)size;
- (UIImage * _Nonnull)renderImageWithSize:(CGSize)size onColor:(UIColor * _Nonnull)color;
...
@interface JotViewController (SWIFT_EXTENSION(SwiftyJot)) <UIGestureRecognizerDelegate>
@end


@interface UIImage (SWIFT_EXTENSION(SwiftyJot))
@end
